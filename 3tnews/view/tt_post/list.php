...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            ...
            <button class="add mt-4" style="margin-left: 2%"><a href="index.php?c=post&a=add">Thêm <i class="fas fa-plus"></i></a></button>
                    ...
                    <table id="listData" class="table table-bordered table-striped dataTable dtr-inline " role="grid"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting text-center"  tabindex="0" aria-controls="example1" rowspan="1"
                                colspan="1"
                                aria-label="Browser: activate to sort column ascending">Tiêu đề
                            </th>
                            <!-- <th class="sorting text-center"  tabindex="0" aria-controls="example1" rowspan="1"
                                colspan="1"
                                aria-label="Browser: activate to sort column ascending">Nọi dung
                            </th> -->
                            <th class="sorting text-center"  tabindex="0" aria-controls="example1" rowspan="1"
                                colspan="1"
                                aria-label="Engine version: activate to sort column ascending">Ảnh
                            </th>
                            <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1"
                                colspan="1"
                                aria-label="Engine version: activate to sort column ascending">Chủ đề
                            </th>
                        ...
                        foreach ($data_post as $item) {
                            ...
                            <tr role="row" class="odd">
                                <td class="align-middle text-center sorting_1" tabindex="0" ><?=$stt++?></td>

                                <td class="align-middle"><span><?= $item->title?></span></td>
                                <!-- <td class="align-middle"><span><?= $item->intro?></span></td> -->

                                <td class=" align-middle text-center"><img class="img" src="../3tnews/assets/images/<?= $item->image ?>" alt=""></td>
                                <td class="align-middle text-center"> <?php
                                                                        foreach ($data_cate as $item1) {
                                                                            if($item->id_cate == $item1->id_cate)  {
                                                                        ?>
                                                                        <?= $item1->name?>
                                                                        <?php
                                                                            }  }
                                ...
                                <td class="text-center align-middle">
                                    <a class="btn btn-primary btn-shadow text-white mr-2" href="index.php?c=post&a=fix&id_post=<?=$item->id_post?>"><i class="fas fa-edit"></i> </a>

                                    <a class="btn btn-success  btn-shadow text-white button-large-delete"
                                       href="javascript:void(0);" onclick="DeleteRecord(<?= $item->id_post ?>)"><i
...
<script>
    ...
    function DoDelete(id_post) {
        $.ajax({
            type: "DELETE",
            url: "index.php?c=post&a=delete&id_post=" + id_post,
            dataType: "html",
