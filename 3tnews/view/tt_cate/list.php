...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            ...
            <button class="add mt-4" style="margin-left: 2%"><a href="index.php?c=category&a=add">Thêm <i class="fas fa-plus"></i></a></button>
                ...
                <div class="card-body">
                    <table id="listData" class="table table-bordered table-striped dataTable dtr-inline " role="grid"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting text-center"  tabindex="0" aria-controls="example1" rowspan="1"
                                colspan="1"
                                aria-label="Browser: activate to sort column ascending">Thể loại
                            </th>
                        ...
                        foreach ($data_cate as $item) {
                            ...
                            <tr role="row" class="odd">
                                <td class="align-middle text-center sorting_1" tabindex="0" ><?= $item->id_cate?></td>
                                <td class="align-middle text-center"><?= $item->name?></td>
                                <td class="text-center align-middle">
                                    <a class="btn btn-primary btn-shadow text-white mr-2" href="index.php?c=category&a=fix&id_cate=<?=$item->id_cate?>"><i class="fas fa-edit"></i> </a>
                                    <a class="btn btn-success  btn-shadow text-white button-large-delete"
                                       href="javascript:void(0);" onclick="DeleteRecord(<?= $item->id_cate ?>)"><i
...
<script>
    ...
    function DoDelete(id_cate) {
        $.ajax({
            type: "DELETE",
            url: "index.php?c=category&a=delete&id_cate=" + id_cate,
            dataType: "html",
