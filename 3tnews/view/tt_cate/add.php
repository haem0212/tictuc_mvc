...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            <form method="post" action="index.php?c=category&a=save" style="width:40% " class="mt-5 mb-5 add-data" enctype="multipart/form-data">
                <h1 class="mb-3 text-uppercase text-primary text-center">Thêm thể loại</h1>
                <div class="form-group">
                    <label for="id">STT</label>
                    <input type="text" class="form-control" name="id_cate" placeholder="Auto">
                </div>
                <div class="form-group">
