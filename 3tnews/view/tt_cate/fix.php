...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            <form method="post" action="index.php?c=category&a=update" style="width:40% " class="mt-5  mb-5 add-data">
                <h1 class="mb-3 text-uppercase text-primary text-center">Sửa thể loại</h1>
                <div class="form-group">
                    <label for="id_cate">STT</label>
                    <input type="text" value="<?=$category->id_cate?>" readonly name="id_cate" class="form-control">
                </div>
                <div class="form-group">
                    <label for="name">Thể loại<span class="text-danger sao">*</span></label>
                ...
                <div class="form-group mt-4">
                    ...
                    <a href="index.php?c=category&a=list" class="button btn btn-primary font-weight-bold">Back</a>
                </div>
            </form>
        </div>
    </div>
