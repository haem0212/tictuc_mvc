...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            <form method="post" action="index.php?c=contact&a=update" style="width:40% " class="mt-5  mb-5 add-data">
                <h1 class="mb-3 text-uppercase text-primary text-center">Sửa liên hệ</h1>
                <div class="form-group">
                    <label for="id">STT</label>
                    <input type="text" value="<?=$contact->id?>" readonly name="id" class="form-control">
                </div>
                <div class="form-group">
                    <label for="fullname">Họ tên<span class="text-danger sao">*</span></label>
                    <input type="text" value="<?=$contact->fullname?>" name="fullname" class="form-control">
                </div>
                <div class="form-group">
                    <label for="email">Email<span class="text-danger sao">*</span></label>
                    <input type="text" value="<?=$contact->email?>" name="email" class="form-control">
                </div>
                <div class="form-group">
                    <label for="phonenumber">Số ĐT<span class="text-danger sao">*</span></label>
                    <input type="text" value="<?=$contact->phonenumber?>" name="phonenumber" class="form-control">
                </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <a href="index.php?c=contact&a=list" class="button btn btn-primary font-weight-bold">Back</a>
                </div>
            </form>
        </div>
    </div>
