...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            <form method="post" action="index.php?c=contact&a=save" style="width:40% " class="mt-5 mb-5 add-data" enctype="multipart/form-data">
                <h1 class="mb-3 text-uppercase text-primary text-center">Thêm liên hệ</h1>
