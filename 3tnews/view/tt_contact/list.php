...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            ...
            <button class="add mt-4" style="margin-left: 2%"><a href="index.php?c=contact&a=add">Thêm <i class="fas fa-plus"></i></a></button>
                    ...
                    <table id="listData" class="table table-bordered table-striped dataTable dtr-inline " role="grid"
                        ...
                        foreach ($data_contact as $item) {
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="align-middle text_left"><?= $item->fullname?></td>
                                <td class="align-middle text_left"><?= $item->email?></td>
                                <td class="align-middle text-center"><?= $item->phonenumber?></td>
                                <td class="text-center align-middle">
                                    <a class="btn btn-primary btn-shadow text-white mr-2" href="index.php?c=contact&a=fix&id=<?=$item->id?>"><i class="fas fa-edit"></i> </a>
...
<script>
    ...
    function DoDelete(id) {
        $.ajax({
            type: "DELETE",
            url: "index.php?c=contact&a=delete&id=" + id,
            dataType: "html",
