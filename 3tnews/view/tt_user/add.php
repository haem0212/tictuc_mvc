...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <div class="col-10">
            <form method="post" action="index.php?c=user&a=save" style="width:40% " class="mt-5 mb-5 add-data" enctype="multipart/form-data">
                <h1 class="mb-3 text-uppercase text-primary text-center">Thêm tài khoản</h1>
                <div class="form-group">
                    <label for="username">Tên đăng nhập<span class="text-danger sao">*</span></label>
                    <input type="text" class="form-control" name="username" placeholder="Enter Username" required>
                </div>
                <div class="form-group">
                    <label for="password">Mật khẩu<span class="text-danger sao">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="user_phone" placeholder="Enter Phonenumber" required>
                </div>
